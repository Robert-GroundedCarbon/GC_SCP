...
module.exports = async (deployer, network, [defaultAccount]) => {
  ...
  GroundedCarbonFarms.setProvider(deployer.provider)
  if (network.startsWith('rinkeby')) {
    await deployer.deploy(GroundedCarbonFarms, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
    let gc = await GroundedCarbonFarms.deployed()
